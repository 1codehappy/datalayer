...
class FactoryIsNotNullTest extends TestCase
{
    /**
     ...
     */
    public function it_creates_an_instance_of_is_not_null_should_be_successful(
        $args,
        $params
    ): void {
